...
class ActionPlanningAgent: 
    ...
    def extract_steps_from_prompt(self, prompt):
        ...
        steps = response_text.split("\n") # to split the response into individual lines. I checked it on: https://stackoverflow.com/questions/4539878/strange-string-split-n-behavior
        steps = [step.strip() for step in steps if step.strip()] # to remove empty lines and leading/trailing whitespace. I found it on: https://www.w3schools.com/python/ref_string_strip.asp#:~:text=Definition%20and%20Usage,any%20whitespaces%20will%20be%20removed.
        return steps